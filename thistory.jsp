        ...
        <form method="get">
            <h3> GET DETAILS </h3>
              <div class="ipBox">
                ...
                <span> ENTER YOUR CID </span>
              
                <i></i>
              </div>
              <div class="links">
                <a href="viewc.jsp">  Go Back  </a>
                <a href="transfer.jsp"> Do you want to make further Transaction ? </a>
              </div>
...
try{
	...
	PreparedStatement ps=conn.prepareStatement("select transfer.cid,tid,tsender,treceiver,tamt from customer,transfer where transfer.cid=customer.cid and customer.cid=?");
	ps.setInt(1,c1);
...
<td><%=rs.getInt("tid") %></td>
<td><%=rs.getString("tsender") %></td>
<td><%=rs.getString("treceiver") %></td>
<td><%=rs.getInt("tamt") %></td>
